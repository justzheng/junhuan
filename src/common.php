...
define('TRANSAC_XF_JF', 'TRIM_XFMF_JF');
define('TRANSAC_XF_QUERY_RES', 'TRIM_XFMF_JGCX');
define('TRANSAC_XF_QUERY_ISXF', 'TRIM_XFMF_SF');
define('TRANSAC_XF_JGTZ', 'TRIM_XFMF_JGTZ');
